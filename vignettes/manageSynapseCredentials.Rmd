...
Login using a personal access token obtained from synapse.org under your Settings. Note that a token must minimally have the view scope to be used with synapser.
