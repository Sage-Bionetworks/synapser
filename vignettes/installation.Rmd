...
1. Select your project's desired Python interpreter
  ...
  ![RStudio Project Options menu](synapser_options.png){#id .class width=600 height=400px}

2. Let's select Python from the list of options on the left hand side:

  ![RStudio Project Options with Python selected in left panel](synapser_python.png){#id .class width=600 height=400px}

3. Click Select

  ![Python interpreter selection dialog](synapser_select_py.png){#id .class width=600 height=400px}

4. Select the Virtual Environments tab:

  ![Python virtual environments tab](synapser_py_env.png){#id .class width=600 height=400px}

5. Click on Select to choose our desired Reticulate virtual environment:

  ![Selected reticulate virtual environment in RStudio](synapser_final.png){#id .class width=600 height=400px}
