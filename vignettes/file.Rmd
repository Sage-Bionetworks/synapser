...
1. List all Folders and Files within your project
...
**Note on very large files:** if you are uploading very large files
(>100 GB each), uploads can take a long time to complete since synapser
uploads one file at a time. Plan accordingly, and consider whether the
[Uploading data in bulk](upload_data_in_bulk.html) workflow better fits
your use case.

First, retrieve the project and folders created in the
[Folders](folder.html) vignette:
...
Next, create the File objects and store them in Synapse:
...
- [Data Upload, Download, and Delete](data_upload_download.html) covers
  downloading files, versioning, and managing annotations in more detail.
- The [File reference page](../reference/File.html) documents every
  constructor argument and method available on a File.
