...
Please see the [Troubleshooting](troubleshooting.html) vignettes for more information.
...
<!--   act$used <- c("syn12345") -->
<!--   act$used <- c(project) -->
<!--   act$used <- c(target = "syn12345", targetVersion = 2) -->
<!-- ``` -->

<!-- URL examples: -->
<!-- ```{r collapse=TRUE} -->
<!--   act$used <- c("http://mydomain.com/my/awesome/data.RData") -->
<!--   act$used <- c(url = "http://mydomain.com/my/awesome/data.RData", name = "Awesome Data") -->
<!--   act$used <- c(url = "https://github.com/joe_hacker/code_repo", name = "Gnarly hacks", wasExecuted = TRUE) -->
<!-- ``` -->
...
The synStore() has shortcuts for specifying the used and executed lists directly to describe what was used and executed to generate a file. For example, when storing a data entity, it’s a good idea to record its source:
