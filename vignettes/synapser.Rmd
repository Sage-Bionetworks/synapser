...
## <a name="Connecting_to_Synapse"></a>Connecting to Synapse
...
## <a name="Organizing_Data_in_a_Project"></a>Organizing Data in a Project
...
## <a name="Annotating_Synapse_Entities"></a>Annotating Synapse Entities
...
For more information about the activity object:
...
## <a name="Evaluations"></a>Evaluations
...
eval <- Evaluation(
  ...
  submissionInstructionsMessage="This evaluation only accept files.")
eval <- synStore(eval)
```
...
List submissions:
```{r collapse=TRUE}
submissions <- synGetSubmissions(eval)
submissions$nextElem()
```
...
## <a name="Sharing_Access_to_Content"></a>Sharing Access to Content
...
## <a name="File_Views"></a>File Views
...
## <a name="Accessing_the_API_Directly"></a>Accessing the API Directly
...
## <a name="Synapse_Utilities"></a>Synapse Utilites
TODO
